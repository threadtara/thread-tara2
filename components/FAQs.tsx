  ...
  return (
    <div className="border-t border-neutral-200 transition-colors duration-200 hover:border-neutral-300">
      ...
      >
        ...
        <span className="mt-0.5 shrink-0 flex items-center justify-center w-6 h-6 rounded-full text-[#c5a059]">
          <svg
        ...
        <span
          ...
          className={`text-base font-medium md:text-lg  ${
            isOpen
              ? "text-[ #c5a059]"
              : "text-neutral-800 group-hover:text-[#c5a059]"
          }`}
        >
          {faq.question}
        </span>
...
export default function FAQ() {
    ...
    <section className="w-full bg-white px-6 py-16 md:px-12 lg:px-24 lg:py-24">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-10 lg:flex-row lg:gap-20">
          ...
          {/* Left — Heading */}
      <div className="lg:w-[38%] flex-col justify-center items-center lg:shrink-0">
  <h2 className="text-6xl font-heading leading-tight tracking-tight text-neutral-800 md:text-5xl lg:text-8xl text-center lg:text-left">
    Frequently
    <br />
    asked
    <br />
  ...
  <p className="mt-4 text-sm text-neutral-400 md:text-base text-center lg:text-left">
    {"Can't find your answer? Call us at "}
    <a
      href="tel:+918750503536"
      className="text-black underline underline-offset-2 transition-colors hover:text-blue-700">
+91 8750503536</a>
